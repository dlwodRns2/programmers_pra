...
import org.example.memberManagementInterface.Member;
import org.example.memberManagementInterface.MemberManager;
...
public class Main {
    ...
    static void saveToFile(ArrayList<Member> memberList){
        ...
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("data/memberInterface.dat"))){
    ...
    static ArrayList<Member> loadFromFile(){
        File file = new File("data/memberInterface.dat");
        if(!file.exists()){
            return new ArrayList<>();
        }

        try(ObjectInputStream ois = new ObjectInputStream(new FileInputStream("data/memberInterface.dat"))){
