...
//대표적인 구현체 : LinkedList, PriorityQueue, ArrayDeque
...
public class A_collections_queue {
    ...
    //Linkedlist는 양방향 리스트로, 큐와 리스트로 모두 사용 가능
    ...
    //2. PriorityQueue
    //우선순위 큐, 요소가 자연 순서(기본 순서)나 제공된 비교기(Comparator)에 따라 데이터 정렬
    //FIFO 순서가 아니라 우선순위에 따라 요소를 처리
