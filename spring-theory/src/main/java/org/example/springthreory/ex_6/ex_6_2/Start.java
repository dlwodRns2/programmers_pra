package org.example.springthreory.ex_6.ex_6_2;

import org.example.springthreory.ex_6.ex_6_2.dao.DaoFactory;
import org.example.springthreory.ex_6.ex_6_2.service.UserService;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

//* 스프링의 프록시 팩토리 빈
//* 문제점
//다이나믹 프록시를 우리가 직접 다뤘음.
//DaoFactory.userService() bean 안에서 Proxy.newProxyInstance를 직접 호출해서 프록시를 얻었고,
//TransactionHandler도 직접 작성해야 한다.
//게다가 '어떤 메서드에 적용할지(패턴)'도 핸들러 안에 섞여 있음.
...
//즉 '무엇을 할 지(트랜잭션)'와 '어디에 적용할 지'가 한 클래스에 엉켜있다.
