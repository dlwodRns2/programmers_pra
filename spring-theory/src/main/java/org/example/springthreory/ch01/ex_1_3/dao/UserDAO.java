package org.example.springthreory.ch01.ex_1_3.dao;
...
//"관계설정 책임의 분리"
//UserDAO 클라이언트 오브젝트가(main)
//제3의 관심사항인 UserDAO와 ConnectionMaker 구현 클래스의 관계를 결정해주는 기능을 분리하서 두기에 적절한 곳이다.
//UserDAO 오브젝트가 다른 오브젝트와 관계를 맺으려면 관계를 맺을 오브젝트가 있어야 할텐데,
//이 오브젝트를 꼭 USerDAO의 코드 내에서 만들 필요는 없음.
//오브젝트는 얼마든지 메서드 파라미터 등을 이용해 전달할 수 있으니, 외부에서 만든 걸 가져올 수도 있다.
