package org.example.springthreory.ch01.ex_1_1;

import org.example.springthreory.ch01.ex_1_1.dao.UserDAO;
import org.example.springthreory.ch01.ex_1_1.domain.User;

import java.sql.SQLException;

//* 관심사의 분리
//개발자가 객체를 설계할 때 가장 염두해 두어야 할 것은 '미래의 변화에 어떻게 대비할 것인가'
