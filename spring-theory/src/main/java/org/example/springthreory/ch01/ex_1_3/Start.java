package org.example.springthreory.ch01.ex_1_3;

import org.example.springthreory.ch01.ex_1_3.dao.DConnectionMaker;
import org.example.springthreory.ch01.ex_1_3.dao.NConnectionMaker;
import org.example.springthreory.ch01.ex_1_3.dao.SimpleConnectionMaker;
import org.example.springthreory.ch01.ex_1_3.dao.UserDAO;

//* 개방 폐쇄의 원칙(OCP, Open-Closed Principal)
//클래스나 모듈은 확장에는 열려 있어야 하고, 변경에는 닫혀 있어야 한다.
//반면 인터페이스를 이용하는 클래스(UserDAO)는 자신의 변화가 불필요하게 일어나지 않도록 굳게 폐쇄 되어있어야 한다.
...
public class Start {
    public static void main(String[] args) {
        ...
        //SimpleConnectionMaker conn2 = new NConnectionMaker();
