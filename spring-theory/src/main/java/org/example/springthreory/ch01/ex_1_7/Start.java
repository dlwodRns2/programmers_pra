package org.example.springthreory.ch01.ex_1_7;

//* 의존관계 주입(DI, Dependency Injection)
//스프링 IoC 기능의 대표적인 동작원리는 주로 의존관계 주입
//의존한다는건 의존대상(B)이 변하면 의존하는(A) 오브젝트에 영향을 미친다
//A에서 B에 의존하고 있지만, 반대로 B는 A에 의존하지 않음
//의존하지 않는다는 말은 B는 A의 변화에 영향을 받지 않는다는 것임.
//의존관계 주입은 구체적인 의존 오브젝트와 그것을 사용할 주체, 보통 클라이언트라고 부르는 오브젝트를
//런타임 시에 연결해주는 작업을 말함
//의존관계 주입의 핵심은 설계 시점에서는 알지 못했던 두 오브젝트의 관계를 맺도록 도와주는
//제 3의 존재가 있다는 것이다(DaoFactory)
