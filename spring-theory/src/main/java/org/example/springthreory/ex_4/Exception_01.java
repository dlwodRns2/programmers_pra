...
public class Exception_01 {
    ...
    //안티페탄2 : 찍기만하고 진행
    //- printStackTrace()나 println()으로 찍는것은 예외를 처리한 것이 아님
    //- 운영 환경에선 그 출력이 묻혀서 아무도 못보고, 프로그램은 잘못된 상태로 계속 동작한다.
    void 찍기만하고진행(){
        try{
            reskyjob();
        }catch(SQLException e){
