...
// 자료형은 크게 기본형과 참조형 두 가지로 나눌 수 있는데, 기본형 변수는 실제 값(data)를 저장하는 반면
...
// * 상수(Constant) : 변수와 마찬가지로 값을 저장할 수 있는 공간이지만, 변수와 달리 한 번 값을 저장하면 다른 값으로 변경할 수 없다.
// 변수 타입 앞에 final을 붙여준다
public class B_variable_method {
    ...
    public static void printResult(int result){
        ...
        2. 함수 종료 : return 문이 실행되면 해당 함수는 즉시 종료
         */
    }
